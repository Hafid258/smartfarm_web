      ...
      <div className="sticky top-0 z-40 border-b border-white/60 bg-white/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold leading-tight text-gray-900">SmartFarm</div>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-6 lg:grid-cols-[260px_1fr]">
        <aside className="h-fit lg:sticky lg:top-[72px]">
          <div className="rounded-2xl border border-white/70 bg-white/80 p-4 shadow-[0_18px_40px_rgba(15,23,42,0.1)] backdrop-blur-sm">
            <div className="mb-3 text-xs font-semibold text-gray-500">เมนูผู้ดูแล</div>
            ...
            <div className="mt-4 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4">
              ...
              <div className="mt-1 text-sm text-gray-700">
                ผู้ดูแลสามารถเลือกฟาร์มจากแต่ละหน้าได้ หากระบบหลังบ้านเปิดสิทธิ์ให้เปลี่ยนฟาร์ม
              </div>
            </div>
          </div>
        </aside>
