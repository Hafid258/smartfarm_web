      ...
      {loading ? (
        ...
        <>
          <Card className="p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
                <div className="text-lg font-semibold text-gray-900">��ػ�����</div>
                <div className="text-sm text-gray-500">
                  {farmSummary?.label || `��ػ�ѹ��� ${selectedDate || todayStr()}`}
                </div>
              </div>
              <Badge variant="blue">�Ҿ����Ӥѭ</Badge>
            </div>

            <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-5">
              <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
                <div className="text-sm text-blue-700">�ѹ���ô��ӡ�����</div>
                <div className="mt-2 text-3xl font-bold text-blue-950">
                  {farmSummary?.summary?.watering_count ?? 0}
                </div>
              </div>
              <div className="rounded-2xl border border-cyan-100 bg-cyan-50/70 p-4">
                <div className="text-sm text-cyan-700">����͡������</div>
                <div className="mt-2 text-3xl font-bold text-cyan-950">
                  {farmSummary?.summary?.mist_count ?? 0}
                </div>
              </div>
              <div className="rounded-2xl border border-emerald-100 bg-emerald-50/70 p-4">
                <div className="text-sm text-emerald-700">�س����������</div>
              ...
              <div className="rounded-2xl border border-violet-100 bg-violet-50/70 p-4">
                <div className="text-sm text-violet-700">�ʧ�����</div>
