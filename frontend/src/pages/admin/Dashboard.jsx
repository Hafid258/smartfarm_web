...
const METRIC_INFO = {
  temperature: {
    title: "อุณหภูมิอากาศ (Temperature)",
    unit: "°C",
    desc: `
อุณหภูมิอากาศมีผลต่อการเติบโตและการคายน้ำของพืช

- ดี: 18-32°C
- ควรระวัง: 32-35°C
- อันตราย: มากกว่า 35°C
`,
  },
  humidity_air: {
    ...
    unit: "%",
    desc: `
ความชื้นอากาศสูงเกินไปเสี่ยงต่อเชื้อรา
ความชื้นต่ำเกินไปทำให้พืชคายน้ำเร็ว

- ดี: 40-90%
- ควรระวัง: ต่ำกว่า 40% หรือสูงกว่า 90%
`,
  },
  soil_moisture: {
    ...
    unit: "%",
    desc: `
ค่าความชื้นดินบอกว่าดินแห้งหรือชื้นมากแค่ไหน
...
`,
  ...
  light_lux: {
    title: "แสงที่พืชได้รับ (Lux)",
    unit: "lux",
    desc: `
ค่าความเข้มแสงจากเซนเซอร์ BH1750

- ต่ำมาก: ต่ำกว่า 2,000 lux
- ปานกลาง: 2,000-4,000 lux
- สูง: มากกว่า 4,000 lux
`,
  },
  vpd: {
    title: "ความแห้งของอากาศ (VPD)",
    unit: "kPa",
    desc: `
VPD ใช้บอกว่าอากาศแห้งหรือชื้นแค่ไหน และมีผลต่อการคายน้ำของพืช

- ดี: 0.8-1.2 kPa
- ควรระวัง: 0.4-0.8 หรือ 1.2-1.5 kPa
- อันตราย: ต่ำกว่า 0.4 หรือสูงกว่า 1.5 kPa
`,
  },
  gdd: {
    title: "ความร้อนสะสม (GDD)",
    unit: "°C",
    desc: `
ดัชนีสะสมความร้อน ใช้ประเมินความเร็วการเติบโตของพืช
...
ถ้า Dew Point ใกล้กับอุณหภูมิอากาศมากเกินไป จะเสี่ยงเชื้อราและโรคพืช

- ดี: ต่างจากอุณหภูมิอากาศมากกว่า 2°C
- ควรระวัง: ต่างกันไม่เกิน 2°C
`,
  },
  soil_drying_rate: {
    title: "ความเร็วที่ดินแห้ง (Soil Drying Rate)",
    unit: "%/min",
    desc: `
อัตราที่ความชื้นดินลดลงต่อเวลา
ยิ่งสูง ยิ่งหมายถึงดินแห้งเร็ว

- ดี: ไม่เกิน 0.15 %/min
- ควรระวัง: 0.15-0.30 %/min
- อันตราย: มากกว่า 0.30 %/min
`,
  },
};
...
export default function Dashboard() {
  ...
  // เธ–เนเธฒเลือกวันที่เนเธงเน เนเธ•เนเธงเธฑเธเธเธฑเนเธเนเธกเนเธกเธตเนเธฅเนเธง โ’ reset
  useEffect(() => {
  ...
  const exportAllFarmsExcel = useCallback(async (options) => {
    try {
      ...
      toast.info("กำลังส่งออกข้อมูลทุกฟาร์ม (แยกชีต)...");
